...
class Gawain_Page2 : AppCompatActivity(), OnClickListener {
...
//        val userName = intent.getStringExtra(Constants.USER_NAME)
        ...
        imageHome.setOnClickListener {
            val intent = Intent(this@Gawain_Page2, PamilianPage::class.java)
...
//            btn_submit.text = "WAKAS"
//        }else{
//            btn_submit.text = "MAGPASA"
//        }
